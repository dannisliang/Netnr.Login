...
namespace Netnr.Login
{
    public class LoginBase
    {
        ...
        public static string EntityToPars<T>(T entity)
        {
            ...
            {
                string value = pi.GetValue(entity)?.ToString();
                if (value != null)
                {
                    result += "&" + pi.Name + "=" + System.Web.HttpUtility.UrlEncode(value);
                }
            }
        ...
        /// <returns></returns>
        public static bool IsValid(object obj, Collection<ValidationResult> validationResults)
        {
